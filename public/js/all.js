  ...
  */
  ...
  OneOp = (function() {
    function OneOp() {
      ...
      this.add_call = __bind(this.add_call, this);      this.running = false;
      this.callbacks = [];
    }
  ...
  DelayedSyncAnimation = (function() {
    function DelayedSyncAnimation() {
      this.ready = __bind(this.ready, this);
      this.ok = __bind(this.ok, this);
      this.wait = __bind(this.wait, this);      this.count = 1;
    }
  ...
  Nimbus.Client.GDrive = {
    check_auth: function() {
      ...
      return (typeof gapi !== "undefined" && gapi !== null) && (gapi.auth != null) && gapi.auth.getToken() !== null;
    },
